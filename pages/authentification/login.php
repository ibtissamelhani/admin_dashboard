        ...
        <div class="sign-up-container">
            ...
            <form id="form" method="post">
                ...
                <div class="form-controls">
                    <input type="text" name="email" id="form-email" placeholder="Your Email" class="input-pd" value='<?php if(isset($_POST['email'])){echo $_POST['email'];}?>'>
                    <small>Error message</small>
                </div>
    
                <label for="form-password">Password</label>
                <div class="form-controls">
                    <input type="password" name="password" id="form-password" placeholder="at least 8 characters" class="input-pd" value='<?php if(isset($_POST['password'])){echo $_POST['password'];}?>'>
